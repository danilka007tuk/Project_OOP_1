...
def test_product_1(product_name_1):
    ...
    assert product_name_1.price_list == 180000.0
...
def test_product_2(product_name_2):
    ...
    assert product_name_2.price_list == 210000.0
...
def test_product_3(product_name_3):
    ...
    assert product_name_3.price_list == 31000.0
...
def test_product_4(product_name_4):
    ...
    assert product_name_4.price_list == 123000.0
